...
function App() {
    ...
    React.useEffect(() => {
        ...
        async function axiosData(){
            ...
            const tyrsData = await axios.get('https://63989d0429930e2bb3bbcda4.mockapi.io/tyrs')
            const cartData = await axios.get('https://63989d0429930e2bb3bbcda4.mockapi.io/cart')
            const favoritesData = await axios.get('https://63989d0429930e2bb3bbcda4.mockapi.io/favorites')
    ...
    const deleteItems=(id)=>{
        console.log(id);
        axios.delete(`https://63989d0429930e2bb3bbcda4.mockapi.io/cart/${id}`)
